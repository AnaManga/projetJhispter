...
@SpringBootTest(classes = NewAppliApp.class)
public class GroupResourceIntTest {
    ...
    /**
     * This repository is mocked in the com.repository.search test package.
     *
     * @see com.repository.search.GroupSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createGroup() throws Exception {
        ...
        assertThat(testGroup.getNom()).isEqualTo(DEFAULT_NOM);
    ...
    public void updateGroup() throws Exception {
        ...
        Group testGroup = groupList.get(groupList.size() - 1);
        assertThat(testGroup.getNom()).isEqualTo(UPDATED_NOM);
